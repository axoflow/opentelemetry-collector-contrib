module github.com/open-telemetry/opentelemetry-collector-contrib/receiver/etwreceiver

go 1.23.0

require (
	github.com/axoflow/axo-etw v0.0.0-20251009132610-a3463ada0a5a
...
replace github.com/bi-zone/etw => github.com/axoflow/etw v0.0.0-20250414111305-cea1014a7f89
