...
Higher verbosity values imply that you get lower levels as well. For example, if you specify `warning` with the value, you receive all `warning`, `error`, and `critical` events.
