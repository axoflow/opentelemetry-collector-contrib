module github.com/open-telemetry/opentelemetry-collector-contrib/connector/bytesconnector
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/connector/bytesconnector/internal/metadata => ./internal/metadata
